...
namespace AmbulanceApp {
    ...
    public partial class AmbulanceDataSet : global::System.Data.DataSet {
        ...
        public partial class CallDataTable : global::System.Data.TypedTableBase<CallRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CallRow AddCallRow(string number, string adress) {
...
namespace AmbulanceApp.AmbulanceDataSetTableAdapters {
    ...
    public partial class CallTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Call] WHERE (([id] = @Original_id) AND ([number] = @Original_n" +
                "umber))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Call] ([number], [adress]) VALUES (@number, @adress);\r\nSELECT " +
                "id, number, adress FROM Call WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Call] SET [number] = @number, [adress] = @adress WHERE (([id] = @Or" +
                "iginal_id) AND ([number] = @Original_number));\r\nSELECT id, number, adress FROM C" +
                "all WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::AmbulanceApp.Properties.Settings.Default.AmbulanceConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, number, adress FROM dbo.Call";
        ...
        public virtual int Insert(string number, string adress) {
            if ((number == null)) {
        ...
        public virtual int Update(string number, string adress, int Original_id, string Original_number, int id) {
            if ((number == null)) {
                throw new global::System.ArgumentNullException("number");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string number, string adress, int Original_id, string Original_number) {
            return this.Update(number, adress, Original_id, Original_number, Original_id);
        }
    }
